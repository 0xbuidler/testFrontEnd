...
/******/ 			var chunk = require("./" + ({"1":"pages/home/home","2":"pages/index","3":"pages/inspire","4":"pages/myDemo"}[chunkId]||chunkId) + ".js");
...
var VSheet = __webpack_require__(102);
...
/* harmony import */ var _mixins_proxyable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(57);
...
"use strict";
/* harmony import */ var _directives__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(41);
/* harmony import */ var _util_console__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
...
var requireObjectCoercible = __webpack_require__(92);
...
var global = __webpack_require__(16);
var createNonEnumerableProperty = __webpack_require__(81);
...
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(vue__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
...
const _be6699a4 = () => interopDefault(__webpack_require__.e(/* import() | pages/inspire */ 3).then(__webpack_require__.bind(null, 160)));

const _cd6d8aea = () => interopDefault(__webpack_require__.e(/* import() | pages/myDemo */ 4).then(__webpack_require__.bind(null, 157)));

const _db8b3a3a = () => interopDefault(__webpack_require__.e(/* import() | pages/home/home */ 1).then(__webpack_require__.bind(null, 158)));

const _3a89a7b4 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 2).then(__webpack_require__.bind(null, 159))); // TODO: remove in Nuxt 3
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=712a06a6&
var defaultvue_type_template_id_712a06a6_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',{attrs:{"dark":""}},[_c('v-navigation-drawer',{attrs:{"mini-variant":_vm.miniVariant,"clipped":_vm.clipped,"fixed":"","app":""},model:{value:(_vm.drawer),callback:function ($$v) {_vm.drawer=$$v},expression:"drawer"}},[_c('v-list',_vm._l((_vm.items),function(item,i){return _c('v-list-item',{key:i,attrs:{"to":item.to,"router":"","exact":""}},[_c('v-list-item-action',[_c('v-icon',[_vm._v(_vm._s(item.icon))])],1),_vm._v(" "),_c('v-list-item-content',[_c('v-list-item-title',{domProps:{"textContent":_vm._s(item.title)}})],1)],1)}),1)],1),_vm._v(" "),_c('v-app-bar',{attrs:{"clipped-left":_vm.clipped,"fixed":"","app":""}},[_c('v-app-bar-nav-icon',{on:{"click":function($event){$event.stopPropagation();_vm.drawer = !_vm.drawer}}}),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){$event.stopPropagation();_vm.miniVariant = !_vm.miniVariant}}},[_c('v-icon',[_vm._v("mdi-"+_vm._s(("chevron-" + (_vm.miniVariant ? "right" : "left"))))])],1),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){$event.stopPropagation();_vm.clipped = !_vm.clipped}}},[_c('v-icon',[_vm._v("mdi-application")])],1),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){$event.stopPropagation();_vm.fixed = !_vm.fixed}}},[_c('v-icon',[_vm._v("mdi-minus")])],1),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){$event.stopPropagation();_vm.rightDrawer = !_vm.rightDrawer}}},[_c('v-icon',[_vm._v("mdi-menu")])],1)],1),_vm._v(" "),_c('v-main',[_c('v-container',[_c('nuxt')],1)],1),_vm._v(" "),_c('v-navigation-drawer',{attrs:{"right":_vm.right,"temporary":"","fixed":""},model:{value:(_vm.rightDrawer),callback:function ($$v) {_vm.rightDrawer=$$v},expression:"rightDrawer"}},[_c('v-list',[_c('v-list-item',{nativeOn:{"click":function($event){_vm.right = !_vm.right}}},[_c('v-list-item-action',[_c('v-icon',{attrs:{"light":""}},[_vm._v(" mdi-repeat ")])],1),_vm._v(" "),_c('v-list-item-title',[_vm._v("Switch drawer (click me)")])],1)],1)],1),_vm._v(" "),_c('v-footer',{attrs:{"absolute":!_vm.fixed,"app":""}},[_c('span',[_vm._v("© "+_vm._s(new Date().getFullYear()))])])],1)}
var defaultvue_type_template_id_712a06a6_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=712a06a6&
...
var VAppBar = __webpack_require__(74);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.array.unscopables.flat.js
var es_array_unscopables_flat = __webpack_require__(45);
...
const baseMixins = Object(mixins["a" /* default */])(VToolbar_VToolbar, scrollable["a" /* default */], ssr_bootable, toggleable["a" /* default */], Object(applicationable["a" /* default */])('top', ['clippedLeft', 'clippedRight', 'computedHeight', 'invertedScroll', 'isExtended', 'isProminent', 'value']));
/* @vue/component */
...
/* harmony default export */ var VAppBar_VAppBar = (baseMixins.extend({
  ...
  computed: {
    ...
    canScroll() {
      return scrollable["a" /* default */].options.computed.canScroll.call(this) && (this.invertedScroll || this.elevateOnScroll || this.hideOnScroll || this.collapseOnScroll || this.isBooted || // If falsey, user has provided an
...
var VGrid = __webpack_require__(63);
...
var VFooter = __webpack_require__(120);
...
/* harmony default export */ var VFooter_VFooter = (Object(mixins["a" /* default */])(VSheet["a" /* default */], Object(applicationable["a" /* default */])('footer', ['height', 'inset']), ssr_bootable).extend({
  name: 'v-footer',
  props: {
    height: {
      default: 'auto',
...
var VList = __webpack_require__(122);
...
var VListItem = __webpack_require__(124);
...
var VListItemGroup = __webpack_require__(130);
...
var VAvatar = __webpack_require__(128);
...
var VMain = __webpack_require__(134);
...
const VNavigationDrawer_baseMixins = Object(mixins["a" /* default */])(Object(applicationable["a" /* default */])('left', ['isActive', 'isMobile', 'miniVariant', 'expandOnHover', 'permanent', 'right', 'temporary', 'width']), colorable["a" /* default */], dependent, mobile, overlayable, ssr_bootable, themeable["a" /* default */]);
/* @vue/component */
...
var default_component = Object(componentNormalizer["a" /* default */])(
  ...
  defaultvue_type_template_id_712a06a6_render,
  defaultvue_type_template_id_712a06a6_staticRenderFns,
  false,
  null,
  null,
  "357c52c8"
...
(function updateModules() {
  store_store = normalizeRoot(__webpack_require__(140), 'store/index.js'); // If store is an exported method = classic mode (deprecated)
...
external_vue_default.a.prototype.$myInjectedFunction = string => console.log('This is an example', string);
// CONCATENATED MODULE: ./plugins/ctx-inject.js
/* harmony default export */ var ctx_inject = (({
  app
}, inject) => {
...
/* harmony default export */ var combined_inject = (({
  app
}, inject) => {
...
/* Plugins */
 ...
 // Source: ../plugins/ctx-inject.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof ctx_inject === 'function') {
    await ctx_inject(app.context, inject);
  }
