...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=3c9a98d6&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-row',{attrs:{"justify":"center","align":"center"}},[_c('v-col',{attrs:{"cols":"12","sm":"8","md":"6"}},[_c('div',[(_vm.show)?_c('v-alert',{attrs:{"type":"success"}},[_vm._v("\n        "+_vm._s(_vm.res)+"\n      ")]):_vm._e()],1),_vm._v(" "),_c('v-btn',{attrs:{"depressed":""},on:{"click":_vm.click1}},[_vm._v(" UP ")]),_vm._v(" "),_c('v-btn',{attrs:{"depressed":"","color":"primary"},on:{"click":_vm.click2}},[_vm._v(" justTest ")]),_vm._v(" "),_c('v-btn',{attrs:{"depressed":"","color":"error"},on:{"click":_vm.click3}},[_vm._v(" AWS专用 ")])],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=3c9a98d6&
...
/* harmony default export */ var lib_vue_loader_options_pagesvue_type_script_lang_js_ = ({
  ...
  methods: {
    async click1() {
      const res = await this.$axios.$get("/liveness").finally(() => {});
      this.res = res;
      this.show = true;
      setTimeout(() => {
        this.show = false;
    ...
    async click2() {
      const res = await this.$axios.$get("/justTest").finally(() => {});
      this.res = res;
      this.show = true;
      setTimeout(() => {
        this.show = false;
    ...
    async click3() {
      const res = await this.$axios.$get("/ethBlockNumber").finally(() => {});
      console.log(res);
      this.res = res;
      this.show = true;
      setTimeout(() => {
...
var VBtn_VBtn = __webpack_require__(42);
...
installComponents_default()(component, {VAlert: VAlert_VAlert,VBtn: VBtn_VBtn["a" /* default */],VCol: VCol["a" /* default */],VRow: VRow["a" /* default */]})
